...
function registerSW() {
  ...
  // Si la app corre bajo /binaural/* en el dominio unificado, el SW del host
  // (/sw.js servido por RESETE-HUB) se encarga del caching. No registrar uno
  // local que entraría en conflicto con el del host.
  if (location.pathname.indexOf('/binaural') === 0) return;
